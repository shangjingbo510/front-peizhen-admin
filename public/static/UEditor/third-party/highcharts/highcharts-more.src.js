  ...
  (function (H) {
    ...
    seriesType(
      ...
      'area',
      {
        ...
        tooltip: {
          pointFormat:
            '<span style="color:{series.color}">\u25CF</span> {series.name}: <b>{point.low}</b> - <b>{point.high}</b><br/>' // eslint-disable-line no-dupe-keys
        },
      ...
      },
      {
        ...
        translate: function () {
          ...
          for (i = 0, len = points.length; i < len; i++) {
            ...
            range = pick(stack && stack[point.x].points[stackIndicator.key], [
              0,
              yValue
            ]);
            ...
            if (point.isSum) {
              ...
              previousY +=
                stack && stack[point.x] ? stack[point.x].total : yValue;
              ...
              this.hasClipCircleSetter = Boolean(
                H.addEvent(this, 'afterRender', function () {
                  ...
                  if (chart.polar) {
                    ...
                    this.group.clip(
                      chart.renderer.clipCircle(circ[0], circ[1], circ[2] / 2)
                    );
                    this.setClip = H.noop;
                  }
                })
      ...
      H.addEvent(H.Chart, 'getAxes', function () {
        ...
        each(
          ...
          function (paneOptions) {
            new H.Pane(paneOptions, this); // eslint-disable-line no-new
          },
          this
        );
      });
