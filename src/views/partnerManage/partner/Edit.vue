  ...
  <div>
    ...
    >
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="推荐人" prop="partnerInfo.recommendId">
            <el-select
              v-model="form.partnerInfo.recommendId"
              filterable
              clearable
              remote
              reserve-keyword
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="学历" prop="partnerInfo.qualification">
            <el-select
              v-model="form.partnerInfo.qualification"
              clearable
              :disabled="viewFlag"
              size="medium"
              placeholder="请选择"
        ...
        <el-col :span="12" v-if="form.partnerInfo.qualification > 4">
...
export default {
  ...
  methods: {
    ...
    async getRecommendList(keyword){
      let res = await getRecommendPartnerList({
        recommendName: keyword
      });
      if (res.code == 1) {
