  ...
  <div class="padding-20">
    ...
    <div class="table">
      <el-table :data="tableData" border>
        ...
        <el-table-column prop="masterName" label="项目经理姓名" width="180" align="center"></el-table-column>
        <el-table-column prop="customerName" label="客户姓名" width="140" align="center"></el-table-column>
        <el-table-column prop="applyTime" label="服务申请时间" align="center"></el-table-column>
...
export default {
  ...
  mounted(){
    this.queryTable();
    //获取服务阶段子节点
    this._getChildNodeListByFlowStep(2);
  },
  methods: {
    //查询
    queryTable(pageNum = 1) {
      ...
      serviceNegotiationList(this.queryForm)
        .then(res => {
          if (res.code == 1) {
    ...
    handleView(id){
      this.$router.push({
        path: '/serviceManage/stageManage/negotiation/detail/' + id
      })
    },
    //删除服务
    delItem(row){
