  ...
  <div class="padding-20">
    <el-form :model="queryForm" label-width="120px" class="form">
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="服务流程阶段" prop="flowStep">
            <el-select
              v-model="queryForm.flowStep"
              clearable
              placeholder="请选择"
              size="medium"
              @change="handleFlowStepChange"
            >
              <el-option
                v-for="item in enumList.FlowStepEnum"
                :key="item.value"
                :label="item.name"
                :value="item.value"
              ></el-option>
    ...
    <div class="table">
      <el-table :data="tableData" border>
        ...
        <el-table-column prop="serviceCode" label="服务编码" align="center"></el-table-column>
        ...
        <el-table-column prop="auditStatusText" label="服务状态" align="center"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    //服务流程阶段改变事件
    handleFlowStepChange(val){
      if(val){
        this.queryForm.childNode = '';
        //获取服务阶段子节点
        this._getChildNodeListByFlowStep(val);
      }else{
        this.queryForm.childNode = '';
        this.childNodesList = [];
      }
    ...
    handleEdit(id){
      this.$router.push({
        path: '/serviceManage/info/Edit/' + id
      })
    },
    handleView(id){
      this.$router.push({
        path: '/serviceManage/info/detail/' + id
      })
    },
    //删除服务
    delItem(row){
